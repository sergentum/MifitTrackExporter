...
//        }
        ...
        try {
            ...
            kv.put("email", "sergentums@gmail.com");
            kv.put("password", "321654987");
            kv.put("v", "2.4");
            kv.put("action", "pair");
...
//        c.put(FEED.URL, String.format(Locale.ENGLISH, WORKOUT_URL,
...
//        c.put(FEED.FEED_TYPE_STRING, sportTxt);
    }
}
